...
class ArtisanController extends Controller
{
    ...
    public function addPaynowAccount(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Paynow account added successfully!');
    }
    ...
    public function uploadNationalDocument(Request $request)
    {
        ...
        try {
            ...
            // Create or update NationalDocument
            ...
            ArtisanVerification::updateOrCreate(
                ['artisan_id' => $artisanProfile->id],
                [
            ...
            return redirect()->back()->with('success', 'National document uploaded successfully. Please wait for verification.');
        } catch (\Exception $e) {
    ...
    public function updatePersonalDetails(Request $request)
    {
        ...
        // Update artisan profile with personal details
        $artisanProfile->update($validated);
