...
$envContent = preg_replace('/^AUTO_VERIFY_ARTISAN=.*/m', 'AUTO_VERIFY_ARTISAN=' . ($enabled ? 'true' : 'false'),
$envContent);
} else {
...
return view('content.apps.artisan-verification', compact('user', 'artisanProfile', 'nationalDocument', 'verification',
'isVerified'));
}
