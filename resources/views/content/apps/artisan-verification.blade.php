    ...
    <div class="col-12 col-lg-4">
      <div class="card bg-gradient border-0 shadow-sm"
        ...
        <div class="card-body p-6">
          ...
          <div class="alert {{ $isVerified ? 'alert-success' : 'alert-warning' }} mb-0" role="alert">
            <div class="d-flex align-items-center">
              <i class="icon-base ri {{ $isVerified ? 'ri-check-circle-fill' : 'ri-alert-circle-fill' }} me-2"></i>
              <span
                class="small fw-medium">{{ $isVerified ? 'Verified and approved' : ($nationalDocument ? 'Awaiting verification' : 'Ready to upload') }}</span>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div class="card bg-light border-0">
                      <div class="card-body">
                        ...
                        <div class="mb-0">
                          ...
                          <span class="badge bg-label-{{ $isVerified ? 'success' : 'warning' }}">
                  ...
                  <div class="alert alert-info border-2" role="alert" style="border-color: #0dcaf0 !important;">
                    <div class="d-flex align-items-start">
                      ...
                      <div>
                        ...
                        <p class="mb-0 small">Your documents have been submitted successfully. Our team is reviewing your
                          information and will notify you shortly. This usually takes 1-2 business days.</p>
                      </div>
                    </div>
                  </div>
