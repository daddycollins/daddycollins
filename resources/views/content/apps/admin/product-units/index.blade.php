...
@section('title', 'Product Units - ArtisanConnect')
...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="row mb-6">
      <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h4 class="mb-0"><i class="ri-ruler-line me-2 text-primary"></i>Product Units</h4>
    ...
    <div class="card mb-4">
      <div class="card-body">
        <form method="GET" action="{{ route('admin.product-units.index') }}" class="row g-3">
          <div class="col-md-6">
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      ...
                      <form action="{{ route('admin.product-units.destroy', $unit->id) }}" method="POST"
                        class="d-inline">
                        @csrf
                        @method('DELETE')
