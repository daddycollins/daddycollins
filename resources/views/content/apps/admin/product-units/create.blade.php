...
@section('title', 'Create Product Unit - ArtisanConnect')

@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="row mb-6">
      <div class="col-12">
        <h4 class="mb-4"><i class="ri-ruler-line me-2 text-primary"></i>Create Product Unit</h4>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <form action="{{ route('admin.product-units.store') }}" method="POST" class="card-body">
            @csrf
