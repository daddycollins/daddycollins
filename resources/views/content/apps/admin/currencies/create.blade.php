...
@section('title', 'Create Currency - ArtisanConnect')

@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="row mb-6">
      <div class="col-12">
        <h4 class="mb-4"><i class="ri-money-dollar-circle-line me-2 text-primary"></i>Create Currency</h4>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <form action="{{ route('admin.currencies.store') }}" method="POST" class="card-body">
            @csrf
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control @error('exchange_rate') is-invalid @enderror" id="exchange_rate"
                name="exchange_rate" value="{{ old('exchange_rate') }}" step="0.0001" required>
            ...
            <div class="d-flex gap-2">
              <button type="submit" class="btn btn-primary">
                <i class="ri-save-line me-1"></i>Create Currency
              </button>
