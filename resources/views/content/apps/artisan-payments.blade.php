            ...
            <div class="border rounded-3 p-4 bg-light">
              ...
              <div class="ps-4">
                <p class="mb-2"><small class="text-muted">ID:</small>
                  <strong>{{ Illuminate\Support\Str::limit($paynowAccount->paynow_integration_id, 5) }}...</strong>
                </p>
...
@section('page-script')
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Add Paynow Form Submission
      const addPaynowForm = document.getElementById('addPaynowForm');
      if (addPaynowForm) {
        // Forms will submit normally through Laravel
      }

      // Edit Paynow Form Submission
      const editPaynowForm = document.getElementById('editPaynowForm');
      if (editPaynowForm) {
        // Forms will submit normally through Laravel
      }
