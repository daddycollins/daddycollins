  ...
  <div class="modal fade" id="editBusinessModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content border-0 shadow-lg">
        ...
        <div class="modal-body">
          <form method="PUT" action="{{ route('artisan-profile-business') }}" id="businessForm">
            @csrf
            @method('PUT')
            <div class="mb-4">
              <label class="form-label fw-medium">Business Name *</label>
              <input type="text" name="business_name" class="form-control"
                value="{{ $artisanProfile->business_name }}" required />
            </div>
            <div class="mb-4">
              <label class="form-label fw-medium">Business Description *</label>
              <textarea name="bio" class="form-control" rows="4" required>{{ $artisanProfile->bio }}</textarea>
            </div>
            <div class="row g-4">
              <div class="col-md-6">
                <label class="form-label fw-medium">Years of Experience *</label>
                <input type="number" name="years_of_experience" class="form-control"
                  value="{{ $artisanProfile->years_of_experience ?? 0 }}" min="0" max="70" required />
              </div>
              <div class="col-md-6">
                <label class="form-label fw-medium">Service Areas *</label>
                <input type="text" name="service_areas" class="form-control"
                  value="{{ $artisanProfile->service_areas }}" required />
              </div>
            </div>
          </form>
        </div>
  ...
  <div class="modal fade" id="editPersonalModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content border-0 shadow-lg">
        ...
        <div class="modal-body">
          <form method="PUT" action="{{ route('artisan-profile-personal') }}" id="personalForm">
            @csrf
            @method('PUT')
            <div class="row g-4">
              <div class="col-12">
  ...
  <div class="modal fade" id="editSocialModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content border-0 shadow-lg">
        ...
        <div class="modal-body">
          <form method="PUT" action="{{ route('artisan-profile-social') }}" id="socialForm">
            @csrf
            @method('PUT')
            <div class="mb-4">
              <label class="form-label fw-medium"><i
